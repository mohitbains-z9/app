            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">Object-oriented programming books explain concepts like classes, objects, inheritance, and polymorphism.
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Your next  destination for quality Books.</p>
            </div>
            <div>
